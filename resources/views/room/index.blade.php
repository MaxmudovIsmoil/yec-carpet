                    ...
                    <div class="modal fade" id="add-model" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="add-model-Lavel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form method="post" action="{{ route('room.ajax_add') }}" id="js_modal_add_form" class="form-group" enctype="multipart/form-data">
                        ...
                        <tbody>
                            ...
                            @foreach($rooms as $room)
                                <tr class="js_this_tr">
                                    ...
                                    <td>
                                        <span class="js_room_name room-name">{{ $room->name }}</span>

                                        <form method="post" action="{{ route('room.ajax_edit') }}" class="js_edit_from room-form-edit form-group d-none mb-0" enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <div class="js_image_div custom-file ml-3">
                                                <input type="file" class="custom-file-input" name="image" multiple="true" id="image">
                                                <label class="custom-file-label" for="image" data-img='{{ $room->image }}'>{{ $room->image }}</label>
                                            </div>
                                    ...
                                    <td class="text-right">
                                        ...
                                        <div class="modal fade" id="delete-model_{{$i}}" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="delete-model_{{$i}}_Lavel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="delete-model_{{$i}}_Lavel">{{ $room->name }}</h5>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    </div>
