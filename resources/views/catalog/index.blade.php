...
{{--                        <button type="button" class="btn btn-secondary">Barchasi</button>--}}
                        ...
                        @foreach($rooms as $k => $r)
                            <button type="button" data-id="{{$r->id}}" class="btn @if($room_first_id == $r->id) btn-primary @else btn-secondary @endif ">{{ $r->name }}</button>
                        @endforeach
                    ...
                    <div class="all-catalogs">
                        ...
                        @foreach($products as $k => $product)
                            <div class="catalog">
                                <img src="{{ url('public/uploaded/product/'.$product->image) }}" alt="image"/>
                                <div class="table-btns">
                                    ...
                                    <div class="edit-delete-btn">
                                        ...
                                        <div class="modal fade" id="edit-model_{{ $product->id }}" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="add-model-Lavel" aria-hidden="true">
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <form method="post" action="{{ route('catalog.ajax_edit') }}" id="js_edit_product_modal_form" class="form-group" enctype="multipart/form-data">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-4 col-12">
                                                                    <label for="articul">Artikul</label>
                                                                    <input type="text" name="articul" id="articul" class="form-control" value="{{ $product->articul }}">
                                                                    <span class="valid-feedback text-danger articul_error"></span>
                                                                </div>
                                                                <div class="col-md-4 col-12">
                                                                    <label for="room_id">Xona</label>
                                                                ...
                                                                <div class="col-md-4 col-12">
                                                                    ...
                                                                    <select type="text" name="quality_id" id="quality_id" class="form-control">
                                                                        <option value="">---</option>
                                                                        @foreach($qualities as $q)
                                                                            <option @if($product->quality_id == $r->id) selected @endif value="{{ $q->id }}">{{ $q->name }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                    <span class="valid-feedback text-danger room_id_error"></span>
                                                                </div>
                                        ...
                                        <a href="#" class="btn btn-sm btn-outline-danger" title="O'chirish">
                                            <svg class="c-icon">
                        ...
                        <div class="catalog">
                            <img src="{{ url('/public/uploaded/room/oshxona.png') }}" alt="image"/>
                            <div class="table-btns">
                                <table class="table">
                                    <tbody>
                                        <tr>
                        ...
                        <div class="catalog">
                            <img src="{{ url('public/uploaded/room/yotoqxona.png') }}" alt="image"/>
                            <div class="table-btns">
                                <table class="table">
                                    <tbody>
                                    <tr>
