                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 offset-md-1">
                                                ...
                                                <span class="room_checkbox_error text-danger"></span>
                                            </div>
                                ...
                                <div class="catalog js_one_product" data-id="{{  $product['id'] }}">
                                    ...
                                    <div class="table-btns">
                                        ...
                                        <div class="edit-delete-btn">
                                            ...
                                            <a href="#" data-url="{{ route('catalog.ajax_delete') }}" data-="{{ $product['code'] }}" data-id="{{ $product['id'] }}" class="btn btn-sm js_delete_btn btn-outline-danger" title="O'chirish" data-toggle="modal" data-target="#delete_notify">
                                                <svg class="c-icon">
